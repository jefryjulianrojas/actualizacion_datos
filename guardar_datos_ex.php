    ...
    if ($_FILES['archivo']['name'][$key]) {
        ...
        if ($conn->query($sql5) === TRUE) {
            echo "<script language='JavaScript'>
                ...
                location.assign('guardar_datos_ex.php');
                </script>";
...
$conn = new mysqli($servername, $username, $password, $dbname);
    ...
    $resultado=mysqli_query($conn,$sql);
         while($filas=mysqli_fetch_assoc($resultado)){
             ...
             $id_p = $filas['id_proveedor'];
      ?>
         <a target=_blank style="border: 2px solid #fff;  padding: 10px 20px" href='imprimir.php?id=<?php echo $id_p;?> '>Descargar Acuerdo De Seguridad</a>
         <a target=_blank style="border: 2px solid #fff;  padding: 10px 20px" href='imprimir2.php?id=<?php echo $id_p;?> '>Descargar Formato de Informacion</a>
    ...
    list-style-type: square; /* Cambiar el tipo de viñeta */
           ...
           <br>
   <h1 style="color: black;">Importante</h1><br>
        <h3 style="color: black;">En la parte superior en el banner  se muestran dos  botones para descargar el Acuerdo De  Seguridad y Formato de informacion con toda  la  informacion actualizada anteriormente. Posteriormente proceda a adjuntar estos documentos  de  la misma manera que se adjuntaron los documentos solicitados por la compañia en el siguiente campo:</h3>
       <hr>
...
?>
     ...
     <br>
      <a href="indexp.php"class="btn2" ><h4 style="font-weight: bold;">finalizar</h4></a>
           </div>
            </form>
