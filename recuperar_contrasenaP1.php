   ...
   <!-- SLOGAN -->
    <div c  lass="slogan">
        ...
        function mostrarCanvas() {
          ...
          <br>  <br>
    <form action="recuperar_contrasenap.php" method="POST">
        <h4>Digita El Numero De Documento</h4><br>
        <input type="text" id="numero_identificacion" style=" width: 35%;" name="numero_identificacion" required><br>
        <button type="submit"  class="banner-btn">Buscar</button>
    </form>
