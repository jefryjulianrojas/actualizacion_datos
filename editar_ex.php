...
<!-- About -->
  ...
  <div class="col-md-12 section-title text-center">
       ...
       <h1> Editar Informacion </h1>
        ...
        <?php
          ...
          $idu= $_SESSION["usuario_id"];
            ...
            if (isset($_POST['enviar'])) {
                ...
                $sql="update experiencia set  nombre_empresa='".$nombre_empresa."', cargo='".$cargo."',funciones='".$funciones."', fecha_inicio='".$fecha_inicio."',  fecha_fin='".$fecha_fin."' WHERE id_experiencia ='$id' ";
        ...
        echo "<script language='JavaScript'>
            ...
            location.assign('datos.php');
                ...
                $id=$_GET['id'];
                $sql="select * from experiencia where id_experiencia='".$id."' ";
                $resultado=mysqli_query($link,$sql);
      ...
      <form action="<?=$_SERVER['PHP_SELF']?>" METHOD="POST">
          <input type="hidden" name="id_experiencia" value="<?php  echo $id?>"><br>
         
        <label for="nivel_educativo">Nombre De Empresa:</label><br>
        <input type="text" name="nombre_empresa" value="<?php echo $nombre_empresa;?>"><br>
        
        <label for="nombre_programa">Cargo:</label><br>
        <input type="text" name="cargo" value="<?php echo $cargo;?>"><br>
        
        <label for="institucion">Funciones:</label><br>
        <input type="text" name="funciones"value="<?php echo $funciones;?>"><br>
        
        <label for="fecha_inicio">Fecha de Ingreso:</label><br>
        <input type="date" name="fecha_inicio" value="<?php echo $fecha_inicio;?>"><br>
          
          
        <label for="fecha_fin">Fecha de Retiro:</label><br>
        <input type="date" name="fecha_fin" value="<?php echo $fecha_fin;?>"><br>
        
        
         
          <input type="hidden" name="idColaborador" value="<?php  echo $idu?>"><br>
