...
$cedulaBuscada = $_POST["numero_identificacion"];

// Consulta SQL para buscar el registro por número de cédula
$sql = "SELECT * FROM proveedor WHERE numero_identificacion = '$cedulaBuscada'";
...
$sql = "UPDATE proveedor SET  contrasena = '$contrasena'  WHERE numero_identificacion = '$cedula'";
                        ...
                        <div id="signature-pad" class="signature-pad" >
                           ...
                           <h4>Digita tu nueva contraseña: </h4>
                                <input type="password" name="contrasena"  style="border: 1px solid #000000; padding: 2px; border-radius: 3px; " required><br>
                                   ...
                                   <input type="hidden" name="numero_identificacion" value="<?php echo $cedula; ?>"  style="border: 1px solid #000000; padding: 2px; border
