...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid"> <a class="navbar-brand navbar-logo" href="index.php"> <img src="images/logo-white.png" alt="logo" class="logo-1"> </a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span class="fas fa-bars"></span> </button>
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item"><a href="index1.php">Inicio</a></li>
...
<div class="banner1 text-center" data-scroll-index='0'>
  <div class="banner-overlay">
    <div class="container">
      <h1 class="text-capitalize"> ¡Bienvenido(a),  <?php echo $_SESSION["usuario_nombre"]; ?> !</h1>
        <br>
        <br>  <div class="text-wrapper">
      <p class="responsive-text">Es un placer darles la más cordial bienvenida a nuestra página de actualización de datos personales. Sabemos que su tiempo es valioso y apreciamos sinceramente el esfuerzo que están dedicando para mantener sus datos personales actualizados.
                     En nuestra continua búsqueda por mejorar nuestros servicios y garantizar una comunicación efectiva, es fundamental contar con información precisa y actualizada de cada uno de ustedes. <br>
                      Por ello, esta página ha sido diseñada para brindarles una plataforma fácil y segura donde puedan actualizar sus datos personales de manera rápida y sencilla. Nos comprometemos a garantizar la confidencialidad y seguridad de su información en todo momento. 
                      Su participación activa en este proceso contribuye significativamente al fortalecimiento de nuestra comunidad empresarial y nos ayuda a ofrecerle un entorno laboral más eficiente y personalizado. <br>
        </p>
        </div>
...
<div class="about-us section-padding" data-scroll-index='1'>
  <div class="container">
    ...
    <br>
    <button type="button" class="banner-btn"  onclick="validar()">Empezar</button>
  </form>
