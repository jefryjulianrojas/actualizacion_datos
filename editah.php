...
$idu= $_SESSION["usuario_id"];
            ...
            if (isset($_POST['enviar'])) {
                ...
                $sql="update hijos set  nombreHijo='".$nombreHijo."', fecha_nacimiento='".$fecha_nacimiento."',edad='".$edad."' WHERE id_hijo ='$id' ";
        ...
        echo "<script language='JavaScript'>
            ...
            location.assign('datos.php');
                ...
                $id=$_GET['id'];
                $sql="select * from hijos where id_hijo='".$id."' ";
                $resultado=mysqli_query($link,$sql);
      ...
      <form action="<?=$_SERVER['PHP_SELF']?>" METHOD="POST">
          <input type="hidden" name="id_hijo" value="<?php  echo $id?>"><br>
         
        <label for="nombreHijo">Nombre:</label><br>
        <input type="text" name="nombreHijo" value="<?php echo $nombreHijo;?>"><br>
