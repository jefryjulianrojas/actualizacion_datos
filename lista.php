...
<div class="banner3 text-center" data-scroll-index='0'>
  <div class="banner-overlay">
    <div class="container">
        <h1 class="text-capitalize">Listado De Proveedores</h1>
        <br>
    ...
    <div class="row">
      <div class="col-md-12 section-title text-center">
            ...
            <div class="row py-4">
                <div class="col">
                    <table class="table table-sm table-bordered table-striped">
                        <thead>
                            <th class="sort asc">N°</th>
                            <th class="sort asc">Numero de Documento o Nit</th>
                            <th class="sort asc">Nombre</th>
                            <th class="sort asc">Direccion</th>
                            <th class="sort asc">Telefono</th>
                            <th class="sort asc">Actividad Economica</th>
                            <th class="sort asc">Nombre Contacto</th>
                            <th colspan="2" class="sort asc">Documentos</th>
       ...
       <div class="container01">
                <a href="ejemplo.php"  class="btn01">agregar</a>
           <br>
           <br>
