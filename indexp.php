...
<div class="banner2 text-center" data-scroll-index='0'>
  <div class="banner-overlay">
    <div class="container">
      <h1 class="text-capitalize"> ¡Bienvenido(a), Proveedor !</h1>
        <br>
        <br>  <div class="text-wrapper">
      <p class="responsive-text">Es un placer darte la más cordial bienvenida a nuestra Plataforma de Registro y Actualización de Datos de Proveedores. Nos emociona enormemente contar contigo como parte de nuestra red de colaboradores, y confiamos en que esta herramienta sea de gran utilidad para simplificar y agilizar nuestros procesos de trabajo conjunto.

Nuestra plataforma ha sido diseñada con el objetivo de brindarte una experiencia fluida y eficiente en el registro inicial y la actualización continua de tus datos. Creemos firmemente que una comunicación clara y una gestión precisa de la información son fundamentales para construir relaciones sólidas y fructíferas.
        </p>
