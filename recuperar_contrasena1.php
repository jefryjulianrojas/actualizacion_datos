...
$cedulaBuscada = $_POST["numero_documento"];

// Consulta SQL para buscar el registro por número de cédula
$sql = "SELECT * FROM colaboradores WHERE numero_documento = '$cedulaBuscada'";
...
$sql = "UPDATE colaboradores SET  contrasena  ='$contra'  WHERE numero_documento = '$cedula'";
...
<div id="signature-pad" class="signature-pad" >
                           ...
                           <h4>Digita tu nueva contraseña: </h4>
                                <input type="password" name="contrasena"  style="border: 1px solid #000000; padding: 2px; border-radius: 3px; " required><br>
                               
                                
                                  <input type="hidden" name="numero_documento" value="<?php echo $cedula; ?>"  style="border: 1px solid #000000; padding: 2px; border
...
<?php 
    ...
    // Mostrar un mensaje indicando que el registro no existe si no se encontraron registros
